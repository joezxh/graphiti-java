...
- [monitor/index.vue](file://graphiti-web/src/views/monitor/index.vue)
...
## 简介
本文件面向Graphiti-Java项目的监控运维实践，围绕Spring Boot Actuator监控指标、健康检查、指标采集与应用状态监控展开；提供Prometheus/Grafana集成建议与自定义指标定义思路；解释日志聚合、错误追踪与性能分析工具配置；给出备份脚本backup.sh与恢复脚本restore.sh的使用方法与恢复流程；并规划告警规则、通知渠道与故障响应流程，以及资源使用、数据库性能与AI服务调用监控的运维仪表板与KPI指标。

## 项目结构
- 后端入口位于graphiti-server模块，配置文件位于resources目录，包含基础配置与开发配置。
- 前端graphiti-web提供监控页面与Actuator数据对接。
- 框架层graphiti-framework提供通用异常处理与安全等基础设施。
- 核心模块graphiti-module-core包含Neo4j、MyBatis、AI服务等业务能力。
- 运维脚本位于scripts目录，日志配置位于config目录。

```mermaid
graph TB
subgraph "前端"
WEB["graphiti-web<br/>监控页面与API客户端"]
end
subgraph "后端"
SERVER["graphiti-server<br/>Spring Boot 应用"]
COMMON["graphiti-framework/graphiti-common<br/>全局异常处理"]
CORE["graphiti-module-core<br/>Neo4j/MyBatis/AI服务"]
end
subgraph "基础设施"
NEO4J["Neo4j 图数据库"]
...
**章节来源**
- [application.yml: 第43-67行:43-67](file://graphiti-server/src/main/resources/application.yml#L43-L67)
- [application-dev.yml: 第615-635行:615-635](file://graphiti-server/src/main/resources/application-dev.yml#L615-L635)
- [monitor.ts: 第74-196行:74-196](file://graphiti-web/src/api/monitor.ts#L74-L196)
- [monitor/index.vue: 第1-607行:1-607](file://graphiti-web/src/views/monitor/index.vue#L1-L607)
- [GlobalExceptionHandler.java: 第17-74行:17-74](file://graphiti-framework/graphiti-common/src/main/java/com/graphiti/common/exception/GlobalExceptionHandler.java#L17-L74)
...
**图表来源**
- [monitor.ts: 第74-196行:74-196](file://graphiti-web/src/api/monitor.ts#L74-L196)
- [monitor/index.vue: 第256-492行:256-492](file://graphiti-web/src/views/monitor/index.vue#L256-L492)
...
**图表来源**
- [GlobalExceptionHandler.java: 第17-74行:17-74](file://graphiti-framework/graphiti-common/src/main/java/com/graphiti/common/exception/GlobalExceptionHandler.java#L17-L74)
- [BusinessException.java: 第1-32行:1-32](file://graphiti-framework/graphiti-common/src/main/java/com/graphiti/common/exception/BusinessException.java#L1-L32)
...
**章节来源**
- [application.yml: 第52-55行:52-55](file://graphiti-server/src/main/resources/application.yml#L52-L55)
...
**章节来源**
- [OpenAiLlmClientServiceImpl.java: 第15-111行:15-111](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/ai/OpenAiLlmClientServiceImpl.java#L15-L111)
...
## 结论
通过Actuator健康检查与指标导出、前端监控面板、全局异常处理与日志配置、备份恢复脚本以及AI服务监控，Graphiti-Java具备完善的监控运维能力。建议在生产环境中启用Prometheus导出与日志聚合，建立告警与故障响应流程，并持续优化指标体系与仪表板，以保障系统的稳定性与可观测性。
...
**章节来源**
- [monitor.ts: 第103-139行:103-139](file://graphiti-web/src/api/monitor.ts#L103-L139)
