...
- 应用默认配置：ontograph-server/src/main/resources/application.yml
- 开发配置模板：ontograph-server/src/main/resources/application-dev.yml
- Neo4j配置类：ontograph-module-core/config/GraphNeo4jConfig.java
- AI配置类：ontograph-module-core/config/GraphitiAiProperties.java
...
- [application.yml:3-67](file://ontograph-server/src/main/resources/application.yml#L3-L67)
...
- Neo4j图数据库
  ...
  - 参考路径：[application-prod.yml:168-172](file://config/application-prod.yml#L168-L172)、[GraphNeo4jConfig.java:20-45](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/config/GraphNeo4jConfig.java#L20-L45)
...
- AI服务提供商密钥与模型参数
  ...
  - 参考路径：[application-prod.yml:76-161](file://config/application-prod.yml#L76-L161)、[GraphitiAiProperties.java:15-96](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/config/GraphitiAiProperties.java#L15-L96)
...
- [GraphNeo4jConfig.java:17-45](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/config/GraphNeo4jConfig.java#L17-L45)
- [GraphitiAiProperties.java:13-96](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/config/GraphitiAiProperties.java#L13-L96)
- [logback-prod.xml:8-83](file://config/logback-prod.xml#L8-L83)
...
- 参考路径
  ...
  - [GraphNeo4jConfig.java:20-45](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/config/GraphNeo4jConfig.java#L20-L45)
...
- 参考路径
  ...
  - [GraphitiAiProperties.java:15-96](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/config/GraphitiAiProperties.java#L15-L96)
...
- 参考路径
  - [application.yml:6-7](file://ontograph-server/src/main/resources/application.yml#L6-L7)
  - [application-prod.yml:10-205](file://config/application-prod.yml#L10-L205)
...
## 结论
本指南梳理了OntoGraph生产环境的关键配置项与最佳实践，涵盖数据库连接池、Redis缓存、Neo4j图数据库、AI服务提供商密钥与模型参数、日志配置、JVM与连接超时调优、配置优先级与覆盖规则，以及配置验证与热更新机制。建议在上线前完成压测与巡检，并建立完善的配置变更流程与审计机制。
