...
- [GraphMetadataMapper.java](file://graphiti-module-core/src/main/java/com/raphiti/module/graphiti/dal/mysql/GraphMetadataMapper.java)
...
- [UserServiceImpl.java](file://graphiti-module-system/src/main/java/com/raphiti/system/service/impl/UserServiceImpl.java)
...
- [SearchHistoryMapper.java](file://graphiti-module-system/src/main/java/com/raphiti/system/dal/mysql/SearchHistoryMapper.java)
- [SearchHistoryDO.java](file://graphiti-module-system/src/main/java/com/raphiti/system/dal/dataobject/SearchHistoryDO.java)
</cite>-->
...
## 简介
本文件系统性梳理 Graphiti Java 项目的“数据访问框架”，重点覆盖以下方面：
...
- graphiti-framework：框架层，包含通用模块与各启动器
...
- graphiti-module-system：系统模块（用户、菜单、日志、配置、搜索历史等）
- graphiti-module-core：核心业务模块（图谱、本体、提示词等）
- graphiti-server：应用入口与配置（application.yml、application-dev.yml）
...
subgraph "业务模块"
SYS_MOD["graphiti-module-system<br/>系统模块"]
CORE_MOD["graphiti-module-core<br/>核心模块"]
end
subgraph "应用入口"
SERVER["graphiti-server<br/>配置与启动"]
end
COMMON --> MYBATIS_ST
COMMON --> REDIS_ST
MYBATIS_ST --> SYS_MOD
...
- [graphiti-spring-boot-starter-mybatis/pom.xml:19-48](file://graphiti-framework/graphiti-spring-boot-starter-mybatis/pom.xml#L19-L48)
- [graphiti-spring-boot-starter-redis/pom.xml:19-36](file://graphiti-framework/graphiti-spring-boot-starter-redis/pom.xml#L19-L36)
...
- [UserMapper.java:1-12](file://graphiti-module-system/src/main/java/com/raphiti/system/dal/mysql/UserMapper.java#L1-L12)
...
- [graphiti-spring-boot-starter-redis/pom.xml:19-36](file://graphiti-framework/graphiti-spring-boot-starter-redis/pom.xml#L19-L36)
- [application.yml:11-19](file://graphiti-server/src/main/resources/application.yml#L11-L19)
- [application-dev.yml:487-507](file://graphiti-server/src/main/resources/application-dev.yml#L487-L507)
...
- [UserMapper.java:1-12](file://graphiti-module-system/src/main/java/com/raphiti/system/dal/mysql/UserMapper.java#L1-L12)
- [UserDO.java:1-38](file://graphiti-module-system/src/main/java/com/raphiti/system/dal/dataobject/UserDO.java#L1-L38)
- [UserServiceImpl.java:1-113](file://graphiti-module-system/src/main/java/com/raphiti/system/service/impl/UserServiceImpl.java#L1-L113)
...
**图表来源**
- [UserServiceImpl.java:90-111](file://graphiti-module-system/src/main/java/com/raphiti/system/service/impl/UserServiceImpl.java#L90-L111)
...
**图表来源**
- [SearchHistoryMapper.java:1-12](file://graphiti-module-system/src/main/java/com/raphiti/system/dal/mysql/SearchHistoryMapper.java#L1-L12)
- [SearchHistoryDO.java:1-29](file://graphiti-module-system/src/main/java/com/raphiti/system/dal/dataobject/SearchHistoryDO.java#L1-L29)
...
MYBATIS --> SYS["graphiti-module-system"]
MYBATIS --> CORE["graphiti-module-core"]
REDIS --> SYS
REDIS --> CORE
```
...
## 附录
- 实战示例路径
  - 用户分页查询：[UserServiceImpl.java:90-111](file://graphiti-module-system/src/main/java/com/raphiti/system/service/impl/UserServiceImpl.java#L90-L111)
  ...
  - 搜索历史分页与保存：[SearchHistoryServiceImpl.java:34-67](file://graphiti-module-system/src/main/java/com/raphiti/system/service/impl/SearchHistoryServiceImpl.java#L34-L67)