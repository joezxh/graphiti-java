...
## 简介
本文件为 ontograph-java 的角色管理接口提供全面的 API 文档，覆盖角色 CRUD 操作、权限分配、状态管理与层级关系。系统采用 RBAC 权限模型，角色与菜单通过中间表关联，支持角色与用户的多对多关系。本文档面向系统管理员，提供完整的端点说明、数据模型定义、请求/响应示例以及最佳实践。
...
- [RoleServiceImpl.java:17-80](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/RoleServiceImpl.java#L17-L80)
- [RoleMapper.java:10-12](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/mysql/RoleMapper.java#L10-L12)
- [RoleDO.java:12-31](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/dataobject/RoleDO.java#L12-L31)
- [MenuDO.java:15-44](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/dataobject/MenuDO.java#L15-L44)
- [MenuMapper.java:10-12](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/mysql/MenuMapper.java#L10-L12)
- [UserController.java:20-74](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/UserController.java#L20-L74)
...
- [RoleServiceImpl.java:14-80](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/RoleServiceImpl.java#L14-L80)
...
章节来源
- [RoleController.java:25-70](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/RoleController.java#L25-L70)
- [RoleService.java:8-48](file://ontograph-module-system/src/main/java/com/graphiti/system/service/RoleService.java#L8-L48)
- [RoleServiceImpl.java:20-80](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/RoleServiceImpl.java#L20-L80)
- [RoleDO.java:12-31](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/dataobject/RoleDO.java#L12-L31)
- [MenuDO.java:15-44](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/dataobject/MenuDO.java#L15-L44)
...
- [role.ts:23-30](file://ontograph-web/src/api/role.ts#L23-L30)
...
- 创建角色
  ...
  - 示例路径：[RoleController.java:30-36](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/RoleController.java#L30-L36)
...
- 更新角色
  ...
  - 示例路径：[RoleController.java:38-44](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/RoleController.java#L38-L44)
...
- 删除角色
  ...
  - 路径参数：roleId（Long）
  - 响应：CommonResult<Boolean>，true 表示成功
  - 示例路径：[RoleController.java:46-53](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/RoleController.java#L46-L53)
...
- 获取角色详情
  ...
  - 示例路径：[RoleController.java:55-62](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/RoleController.java#L55-L62)
...
- 获取角色列表
  ...
  - 示例路径：[RoleController.java:64-69](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/RoleController.java#L64-L69)
...
- 角色状态管理（前端常用）
  ...
  - 示例路径：[role.ts:136-142](file://ontograph-web/src/api/role.ts#L136-L142)
...
- [role.ts:99-142](file://ontograph-web/src/api/role.ts#L99-L142)
...
- [UserController.java:24-74](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/UserController.java#L24-L74)
- [AuthController.java:16-54](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/AuthController.java#L16-L54)
...
图表来源
- [RoleController.java:25-28](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/RoleController.java#L25-L28)
- [RoleServiceImpl.java:22-22](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/RoleServiceImpl.java#L22-L22)
- [MenuMapper.java:10-12](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/mysql/MenuMapper.java#L10-L12)
...
- [AuthController.java:20-21](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/AuthController.java#L20-L21)
...
章节来源
- [schema.sql:30-86](file://sql/mysql/schema.sql#L30-L86)
- [role.ts:53-78](file://ontograph-web/src/api/role.ts#L53-L78)

## 故障排除指南
- 角色编码重复
  - 现象：创建角色时报错“角色编码已存在”
  - 处理：更换唯一编码后重试
  - 参考：[RoleServiceImpl.java:26-30](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/RoleServiceImpl.java#L26-L30)
- 未提供 Bearer Token
  - 现象：401 未授权
  - 处理：先调用登录接口获取 JWT，再在请求头添加 Authorization: Bearer <token>
  - 参考：[AuthController.java:27-32](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/AuthController.java#L27-L32)
- 路径参数缺失或类型错误
  - 现象：404 或 400
  - 处理：确认路径参数 roleId 类型为 Long，且存在有效值
  - 参考：[RoleController.java:46-53](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/RoleController.java#L46-L53)

章节来源
- [RoleServiceImpl.java:26-30](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/RoleServiceImpl.java#L26-L30)
...
- [RoleController.java:46-53](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/RoleController.java#L46-L53)

## 结论
ontograph-java 的角色管理接口以清晰的分层架构实现了 RBAC 权限模型，支持角色的完整生命周期管理与动态授权。通过角色与菜单、用户的关系设计，系统能够灵活地实现权限控制与审计追踪。建议在生产环境中配合缓存与索引策略，进一步提升性能与稳定性。
