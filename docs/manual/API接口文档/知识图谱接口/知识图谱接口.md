...
## 项目结构
后端采用 Spring Boot + MyBatis 架构，核心模块位于 ontograph-module-core，Admin 控制器集中于 admin 包；公共响应封装位于 graphiti-common。接口统一通过 Swagger 注解标注，便于生成文档与联调。
...
- [OntologyController.java:20-232](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/OntologyController.java#L20-L232)
- [SearchController.java:23-138](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/SearchController.java#L23-L138)
- [TemporalController.java:16-67](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/TemporalController.java#L16-L67)
- [CommonResult.java:14-68](file://ontograph-framework/graphiti-common/src/main/java/com/graphiti/common/response/CommonResult.java#L14-L68)
...
- [CommonResult.java:39-45](file://ontograph-framework/graphiti-common/src/main/java/com/graphiti/common/response/CommonResult.java#L39-L45)
...
- [CreateGraphReqVO.java:10-23](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/graph/CreateGraphReqVO.java#L10-L23)
- [UpdateGraphReqVO.java:9-23](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/graph/UpdateGraphReqVO.java#L9-L23)
- [GraphStatsRespVO.java:9-48](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/graph/GraphStatsRespVO.java#L9-L48)
...
章节来源
- [NodeController.java:35-143](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/NodeController.java#L35-L143)
- [NodeFilterReqVO.java:9-33](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/node/NodeFilterReqVO.java#L9-L33)
...
章节来源
- [EdgeController.java:33-91](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/EdgeController.java#L33-L91)
- [EdgeFilterReqVO.java:9-38](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/edge/EdgeFilterReqVO.java#L9-L38)
...
章节来源
- [OntologyController.java:32-232](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/OntologyController.java#L32-L232)
...
章节来源
- [SearchController.java:33-138](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/SearchController.java#L33-L138)
- [SearchQueryReqVO.java:14-33](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/search/SearchQueryReqVO.java#L14-L33)
...
- 创建图谱
  ...
  - 参考路径：[GraphitiController.java:53-59](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/GraphitiController.java#L53-L59)，[CreateGraphReqVO.java:10-23](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/graph/CreateGraphReqVO.java#L10-L23)，[CommonResult.java:39-45](file://ontograph-framework/graphiti-common/src/main/java/com/graphiti/common/response/CommonResult.java#L39-L45)
- 获取节点列表
  - 请求：GET /api/v1/nodes/list?graphId=&name=&type=&skip=&limit=
  - 响应：CommonResult.success(List<NodeListRespVO>)
  - 参考路径：[NodeController.java:35-42](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/NodeController.java#L35-L42)，[NodeFilterReqVO.java:9-33](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/node/NodeFilterReqVO.java#L9-L33)
- 边的创建与查询
  - 创建：POST /api/v1/graph/edge/{graphId}（Body：Map<String,Object>）
  - 查询详情：GET /api/v1/graph/edge/{graphId}/{edgeUuid}
  - 参考路径：[EdgeController.java:53-59](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/EdgeController.java#L53-L59)，[EdgeController.java:44-51](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/EdgeController.java#L44-L51)
- 搜索检索
  - 图谱内搜索：POST /api/v1/graph/search/graph/{graphId}
  - 语义搜索：POST /api/v1/graph/search/semantic/{graphId}?query=&limit=
  - 参考路径：[SearchController.java:40-47](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/SearchController.java#L40-L47)，[SearchController.java:104-118](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/SearchController.java#L104-L118)，[SearchQueryReqVO.java:14-33](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/search/SearchQueryReqVO.java#L14-L33)
- 时序历史
  - 指定时间点关系：GET /api/v1/graph/{graphId}/temporal/relationships/at/{referenceTime}
  - 参考路径：[TemporalController.java:40-47](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/TemporalController.java#L40-L47)