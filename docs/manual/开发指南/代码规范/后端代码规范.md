...
## 引言
本规范面向OntoGraph后端工程，基于现有代码库总结出统一的Spring Boot代码组织与实现规范，覆盖包命名、类设计、控制器/服务/数据访问层职责划分、实体/DTO/VO命名与字段规范、异常与日志、事务管理、统一响应包装、全局异常处理、JWT认证与安全配置、单元测试与Mock实践、代码注释与接口文档、API设计原则等内容。目标是提升代码一致性、可维护性与协作效率。
...
subgraph "业务模块"
SYS["ontograph-module-system<br/>认证/用户/菜单/系统配置"]
CORE["ontograph-module-core<br/>图谱/实体/抽取/推理/搜索"]
end
subgraph "服务端"
APP["ontograph-server<br/>启动类/配置/Swagger"]
end
COMMON --> SYS
COMMON --> CORE
SEC --> SYS
...
- [AuthController.java:1-55](file://ontograph-module-system/src/main/java/com/raphiti/system/controller/AuthController.java#L1-L55)
- [AuthServiceImpl.java:1-67](file://ontograph-module-system/src/main/java/com/raphiti/system/service/impl/AuthServiceImpl.java#L1-L67)
...
- [AuthController.java:1-55](file://ontograph-module-system/src/main/java/com/raphiti/system/controller/AuthController.java#L1-L55)
- [AuthService.java:1-26](file://ontograph-module-system/src/main/java/com/raphiti/system/service/AuthService.java#L1-L26)
- [AuthServiceImpl.java:1-67](file://ontograph-module-system/src/main/java/com/raphiti/system/service/impl/AuthServiceImpl.java#L1-L67)
- [CommonResult.java:1-68](file://ontograph-framework/graphiti-common/src/main/java/com/raphiti/common/response/CommonResult.java#L1-L68)
- [BusinessException.java:1-33](file://ontograph-framework/graphiti-common/src/main/java/com/raphiti/common/exception/BusinessException.java#L1-L33)
...
**章节来源**
- [LoginRequest.java:1-26](file://ontograph-module-system/src/main/java/com/raphiti/system/dto/LoginRequest.java#L1-L26)
- [LoginResponse.java:1-39](file://ontograph-module-system/src/main/java/com/raphiti/system/dto/LoginResponse.java#L1-L39)
- [GraphInfoRespVO.java:1-42](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/vo/graph/GraphInfoRespVO.java#L1-L42)
