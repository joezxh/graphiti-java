...
## 简介
本指南面向开发者与运维工程师，围绕 ontograph-java 后端服务提供一套完整的调试与性能分析实践，涵盖：
- IDE 调试配置、断点设置与变量监控
- 日志级别配置、日志分析工具与错误追踪
...
- ontograph-framework：通用框架与基础设施（安全、公共响应、MyBatis-Plus、Redis 等）
- ontograph-module-core：业务域实现（图谱、本体、导入导出、Neo4j/MySQL/Redis 集成）
- ontograph-web：前端控制台（监控页、API 文档等）
...
**图表来源**
- [GraphitiApplication.java:18-39](file://ontograph-server/src/main/java/com/graphiti/GraphitiApplication.java#L18-L39)
...
- [GraphNeo4jService.java:941-972](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/GraphNeo4jService.java#L941-L972)
- [monitor.ts:75-196](file://ontograph-web/src/api/monitor.ts#L75-L196)
- [index.vue:256-322](file://ontograph-web/src/views/monitor/index.vue#L256-L322)
...
- [JwtAuthenticationFilter.java:26-60](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/jwt/JwtAuthenticationFilter.java#L26-L60)
- [GlobalExceptionHandler.java:17-73](file://ontograph-framework/graphiti-common/src/main/java/com/graphiti/common/exception/GlobalExceptionHandler.java#L17-L73)
- [monitor.ts:75-97](file://ontograph-web/src/api/monitor.ts#L75-L97)
