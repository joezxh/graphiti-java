...
- [graphiti-server/src/main/java/com/GraphitiApplication.java](file://graphiti-server/src/main/java/com/GraphitiApplication.java)
...
## 简介
本指南面向 Graphiti-Java 项目的开发与配置管理，覆盖开发工具安装与配置（Postman、DBeaver、Neo4j Browser）、构建脚本与自动化任务、CI/CD 流水线建议、IDE 配置模板、代码格式化与静态分析工具、数据库管理与 API 测试工具、性能监控工具，以及开发与测试环境配置差异。文档同时结合项目实际的配置文件与脚本，提供可落地的操作步骤。

## 项目结构
项目采用多模块 Maven 结构，包含框架基础模块、业务模块、服务入口与前端工程，并配套数据库初始化脚本与运维文档。关键模块与职责如下：
- graphiti-framework：通用框架与基础设施（安全、MyBatis、Redis）
- graphiti-module-system：系统管理（用户、角色、菜单、权限）
- graphiti-module-core：核心业务（知识图谱、搜索、导入、本体、社区）
- graphiti-server：Spring Boot 启动入口与配置
- graphiti-web：Vue 3 前端工程
...
- [graphiti-server/src/main/java/com/GraphitiApplication.java:18-34](file://graphiti-server/src/main/java/com/GraphitiApplication.java#L18-L34)
...
- [graphiti-framework/graphiti-spring-boot-starter-mybatis/pom.xml:19-41](file://graphiti-framework/graphiti-spring-boot-starter-mybatis/pom.xml#L19-L41)
...
```mermaid
graph TB
A["浏览器/客户端"] --> B["graphiti-web<br/>Vite 开发服务器"]
B --> C["graphiti-server<br/>Spring Boot 应用"]
C --> D["graphiti-module-core<br/>业务服务"]
C --> E["graphiti-module-system<br/>系统服务"]
D --> F["Neo4j<br/>图数据库"]
...
- 前端自动化
  ...
  - Vite 开发服务器端口与代理配置
- 批处理脚本
  - graphiti-web 提供 install.bat 与 setup.bat，一键安装依赖并启动开发服务器
...
- [graphiti-web/vite.config.ts:9-13](file://graphiti-web/vite.config.ts#L9-L13)
...
- [graphiti-web/package.json:9](file://graphiti-web/package.json#L9)
...
- [graphiti-server/src/main/resources/application-dev.yml:503-507](file://graphiti-server/src/main/resources/application-dev.yml#L503-L507)
...
章节来源
- [graphiti-server/src/main/resources/application.yml:44-56](file://graphiti-server/src/main/resources/application.yml#L44-L56)
- [graphiti-server/src/main/resources/application-dev.yml:615-635](file://graphiti-server/src/main/resources/application-dev.yml#L615-L635)
...
章节来源
- [graphiti-server/src/main/resources/application.yml:36-67](file://graphiti-server/src/main/resources/application.yml#L36-L67)
- [graphiti-server/src/main/resources/application-dev.yml:609-676](file://graphiti-server/src/main/resources/application-dev.yml#L609-L676)
...
- [README.md:477-491](file://README.md#L477-L491)
- [graphiti-server/src/main/resources/application.yml:54-56](file://graphiti-server/src/main/resources/application.yml#L54-L56)
...
participant Server as "graphiti-server"
...
- [sql/neo4j/init.cypher:1-33](file://sql/neo4j/init.cypher#L1-L33)
- [sql/postgresql/schema.sql:1-319](file://sql/postgresql/schema.sql#L1-L319)
- [graphiti-server/src/main/resources/application-dev.yml:487-507](file://graphiti-server/src/main/resources/application-dev.yml#L487-L507)