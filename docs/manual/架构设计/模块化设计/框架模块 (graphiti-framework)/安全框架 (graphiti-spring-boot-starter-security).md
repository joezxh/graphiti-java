...
- [pom.xml](file://graphiti-framework/graphiti-spring-boot-starter-security/pom.xml)
...
## 简介
本文件面向Graphiti-Java安全框架模块（graphiti-spring-boot-starter-security），系统性阐述基于Spring Security与JWT的认证与授权实现，覆盖以下主题：
...
## 项目结构
安全模块位于graphiti-framework/graphiti-spring-boot-starter-security目录，主要由以下层次构成：
...
- [AuthController.java:20-36](file://graphiti-module-system/src/main/java/com/graphiti/system/controller/AuthController.java#L20-L36)
...
- [auth.ts（前端工具）:1-40](file://graphiti-web/src/utils/auth.ts#L1-L40)
- [router/index.ts:198-232](file://graphiti-web/src/router/index.ts#L198-L232)
...
- [JwtTokenProvider.java:13-86](file://graphiti-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/jwt/JwtTokenProvider.java#L13-L86)
- [UserContext.java:9-49](file://graphiti-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/util/UserContext.java#L9-L49)
...
- [AuthServiceImpl.java:30-43](file://graphiti-module-system/src/main/java/com/graphiti/system/service/impl/AuthServiceImpl.java#L30-L43)
...
- [AuthController.java:27-32](file://graphiti-module-system/src/main/java/com/graphiti/system/controller/AuthController.java#L27-L32)
- [AuthServiceImpl.java:27-44](file://graphiti-module-system/src/main/java/com/graphiti/system/service/impl/AuthServiceImpl.java#L27-L44)
- [LoginRequest.java:11-25](file://graphiti-module-system/src/main/java/com/graphiti/system/dto/LoginRequest.java#L11-L25)
...
- [router/index.ts:198-232](file://graphiti-web/src/router/index.ts#L198-L232)
- [auth.ts:26-50](file://graphiti-web/src/api/auth.ts#L26-L50)
- [auth.ts（前端工具）:14-30](file://graphiti-web/src/utils/auth.ts#L14-L30)
...
图表来源
- [pom.xml:16-47](file://graphiti-framework/graphiti-spring-boot-starter-security/pom.xml#L16-L47)
...
- [JwtTokenProvider.java:19-33](file://graphiti-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/jwt/JwtTokenProvider.java#L19-L33)
...
- [UserContext.java:20-21](file://graphiti-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/util/UserContext.java#L20-L21)
...
- [SecurityConfig.java:84-113](file://graphiti-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/config/SecurityConfig.java#L84-L113)
- [JwtAuthenticationFilter.java:44-59](file://graphiti-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/jwt/JwtAuthenticationFilter.java#L44-L59)
- [UserContext.java:19-32](file://graphiti-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/util/UserContext.java#L19-L32)

## 结论
Graphiti-Java安全模块采用Spring Security + JWT的无状态认证方案，具备清晰的过滤器链、统一的异常处理与CORS配置。JwtTokenProvider负责Token生命周期管理，JwtAuthenticationFilter完成请求级的身份注入，UserContext提供便捷的当前用户访问。结合系统模块的认证服务与前端路由守卫，形成完整的登录、鉴权与会话管理闭环。
