...
## 简介
本文件面向开发者，系统化阐述 ontograph-java 实体关系管理子系统的设计与实现，覆盖节点与边的管理、实体识别与关系抽取、实体去重与关系验证、命名空间与本体类映射、数据质量保障机制，并提供 API 接口文档、处理流程图与实践案例，帮助快速理解与扩展。

## 项目结构
- 后端采用模块化分层：ontograph-server（入口）、ontograph-module-core（核心业务）、ontograph-module-system（系统管理）、ontograph-framework（基础设施）
- 实体关系管理主要集中在 ontograph-module-core 的 controller、service、namespace、util、vo、resources/prompts 等包
- 前端 ontograph-web 通过 API 与后端交互，后端通过 Swagger 提供在线接口文档
...
FRAME["ontograph-framework<br/>基础设施"]
end
subgraph "存储"
NEO4J["Neo4j<br/>图数据库"]
...
- [EntityDedupServiceImpl.java:1-398](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EntityDedupServiceImpl.java#L1-L398)
- [StringNormalizer.java:1-82](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/util/StringNormalizer.java#L1-L82)
- [MinHashLSH.java:1-196](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/util/MinHashLSH.java#L1-L196)
...
## 架构总览
系统采用"控制器-服务-数据访问"的分层架构，结合 Neo4j 与 PostgreSQL/Redis，实现实体关系的全生命周期管理。
...
图表来源
- [NodeController.java:23-28](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/controller/admin/NodeController.java#L23-L28)
- [EdgeController.java:23-31](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/controller/admin/EdgeController.java#L23-L31)
- [NodeServiceImpl.java:26-31](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/NodeServiceImpl.java#L26-L31)
- [EdgeServiceImpl.java:25-29](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EdgeServiceImpl.java#L25-L29)
- [EntityExtractorServiceImpl.java:26-30](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EntityExtractorServiceImpl.java#L26-L30)
- [EdgeExtractorServiceImpl.java:25-30](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EdgeExtractorServiceImpl.java#L25-L30)
- [DataQualityServiceImpl.java:22-24](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/DataQualityServiceImpl.java#L22-L24)
- [EntityDedupServiceImpl.java:41-45](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EntityDedupServiceImpl.java#L41-L45)
...
- [NodeService.java:13-78](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/NodeService.java#L13-L78)
...
- [EdgeServiceImpl.java:25-171](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EdgeServiceImpl.java#L25-L171)

章节来源
- [EdgeController.java:23-90](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/controller/admin/EdgeController.java#L23-L90)
- [EdgeService.java:12-60](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/EdgeService.java#L12-L60)
- [EdgeServiceImpl.java:31-114](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EdgeServiceImpl.java#L31-L114)
...
章节来源
- [EntityExtractorServiceImpl.java:34-128](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EntityExtractorServiceImpl.java#L34-L128)
- [EdgeExtractorServiceImpl.java:34-124](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EdgeExtractorServiceImpl.java#L34-L124)
...
- [MinHashLSH.java:18-128](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/util/MinHashLSH.java#L18-L128)

章节来源
- [EntityDedupServiceImpl.java:21-172](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EntityDedupServiceImpl.java#L21-L172)
- [StringNormalizer.java:7-81](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/util/StringNormalizer.java#L7-L81)
...
章节来源
- [DataQualityServiceImpl.java:15-219](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/DataQualityServiceImpl.java#L15-L219)
...
- [DataQualityServiceImpl.java](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/DataQualityServiceImpl.java#L24)

章节来源
- [NodeServiceImpl.java:26-30](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/NodeServiceImpl.java#L26-L30)
- [EdgeServiceImpl.java:25-29](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EdgeServiceImpl.java#L25-L29)
- [EntityDedupServiceImpl.java:41-45](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/EntityDedupServiceImpl.java#L41-L45)
- [DataQualityServiceImpl.java:22-24](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/DataQualityServiceImpl.java#L22-L24)
...
章节来源
- [NodeServiceImpl.java:74-87](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/service/impl/NodeServiceImpl.java#L74-L87)
...
章节来源
- [OntologyFullVO.java:15-36](file://ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/vo/ontology/OntologyFullVO.java#L15-L36)
