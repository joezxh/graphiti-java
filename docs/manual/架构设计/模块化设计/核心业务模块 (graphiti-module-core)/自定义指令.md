...
- [CustomInstructionNamespace.java](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/namespace/CustomInstructionNamespace.java)
...
NS["CustomInstructionNamespace<br/>命名空间"]
end
subgraph "前端"
...
- [CustomInstructionNamespace.java:26-44](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/namespace/CustomInstructionNamespace.java#L26-L44)
...
### 命名空间：CustomInstructionNamespace
- 作用
  - 对外暴露门面方法，屏蔽底层服务细节
  - 提供获取、创建、删除的统一入口
- 日志
...
class CustomInstructionNamespace
...
CustomInstructionNamespace --> CustomInstructionService : "依赖"
```
...
- [CustomInstructionNamespace.java:21-21](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/namespace/CustomInstructionNamespace.java#L21-L21)
