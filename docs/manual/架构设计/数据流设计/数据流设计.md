...
## 简介
本文件面向开发者，系统化梳理 ontograph-java 的数据流设计，覆盖从用户输入到数据持久化的完整路径，以及 AI 数据处理、混合搜索与数据导入的专项流程。重点包括：
...
## 项目结构
ontograph-java 采用分层模块化架构，后端以 Spring Boot 为核心，业务集中在 ontograph-module-core，数据访问通过 Neo4j 与关系型数据库协同，框架层提供安全、缓存与基础设施支持。

```mermaid
graph TB
FE["前端 Web<br/>ontograph-web"] --> API["Spring Boot 应用<br/>ontograph-server"]
...
- [DataImportController.java:22-27](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/DataImportController.java#L22-L27)
- [SearchController.java:23-28](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/SearchController.java#L23-L28)
...
章节来源
- [DataImportController.java:22-72](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/DataImportController.java#L22-L72)
...
- [DataImportServiceImpl.java:27-109](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/DataImportServiceImpl.java#L27-L109)
- [SearchServiceImpl.java:21-148](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/SearchServiceImpl.java#L21-L148)
- [Neo4jDriverAdapter.java:33-83](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/Neo4jDriverAdapter.java#L33-L83)
...
图表来源
- [SearchController.java:88-137](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/SearchController.java#L88-L137)
...
章节来源
- [SearchController.java:23-137](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/SearchController.java#L23-L137)
- [SearchServiceImpl.java:21-520](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/SearchServiceImpl.java#L21-L520)
- [SearchQueryReqVO.java:14-32](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/search/SearchQueryReqVO.java#L14-L32)
- [pipeline.md:1126-1156](file://docs/pipeline.md#L1126-L1156)
...
章节来源
- [EntityExtractorServiceImpl.java:67-95](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/EntityExtractorServiceImpl.java#L67-L95)
...
- [SearchController.java:31-32](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/SearchController.java#L31-L32)
...
章节来源
- [vector-index-init.cypher:1-26](file://sql/neo4j/vector-index-init.cypher#L1-L26)
- [SearchServiceImpl.java:115-148](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/SearchServiceImpl.java#L115-L148)
...
章节来源
- [DataImportServiceImpl.java:254-279](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/DataImportServiceImpl.java#L254-L279)
...
## 结论
ontograph-java 通过清晰的分层架构与模块化设计，实现了从用户输入到图数据库的高效数据流。AI 驱动的实体/关系抽取与向量嵌入，结合 Neo4j 的向量与全文索引，支撑了强大的混合搜索能力。建议在批量导入与并发写入场景中引入事务批处理与缓存策略，持续优化检索参数与索引配置，以获得更佳的性能与稳定性。
