...
- [ExtractedJudgmentVO.java](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedJudgmentVO.java)
...
- [ExtractedLawyerVO.java](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedLawyerVO.java)
- [ExtractedJudgeVO.java](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedJudgeVO.java)
- [ExtractedEvidenceVO.java](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedEvidenceVO.java)
...
## 简介
本文件面向法律数据处理专家，系统化阐述Graphiti-Java的法律数据抽取与导入管道，覆盖从法律文书解析、要素识别、结构化提取、本体映射、Neo4j存储到质量控制与合规性的完整流程。文档同时深入分析ExtractedCaseVO、ExtractedCourtVO、ExtractedJudgmentVO等法律实体的数据结构，解释法律本体系统的术语标准化、关系约束验证与案例相似性分析能力，并提供API接口、批量处理策略与合规性建议。

## 项目结构
- 后端采用Spring Boot模块化设计，核心业务位于graphiti-module-core，包含控制器、服务层、数据访问层与视图对象（VO）。
...
- 视图对象（VO）位于graphiti-module-core/src/main/java/.../vo/legal，定义了法律实体的结构化输出。
...
**章节来源**
- [LegalExtractController.java:25-152](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/LegalExtractController.java#L25-L152)
- [LegalImportController.java:20-121](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/LegalImportController.java#L20-L121)
- [LegalExtractServiceImpl.java:16-35](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/LegalExtractServiceImpl.java#L16-L35)
- [LegalImportServiceImpl.java:13-27](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/LegalImportServiceImpl.java#L13-L27)
...
**图表来源**
- [LegalExtractController.java:86-152](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/LegalExtractController.java#L86-L152)
...
**章节来源**
- [LegalExtractController.java:25-284](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/LegalExtractController.java#L25-L284)
...
**章节来源**
- [LegalImportController.java:20-135](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/LegalImportController.java#L20-L135)
...
**图表来源**
- [LegalExtractServiceImpl.java:16-820](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/LegalExtractServiceImpl.java#L16-L820)

**章节来源**
- [LegalExtractServiceImpl.java:75-787](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/LegalExtractServiceImpl.java#L75-L787)
...
**章节来源**
- [LegalImportServiceImpl.java:28-202](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/LegalImportServiceImpl.java#L28-L202)
...
**图表来源**
- [ExtractedCaseVO.java:10-40](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedCaseVO.java#L10-L40)
- [ExtractedCourtVO.java:10-32](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedCourtVO.java#L10-L32)
- [ExtractedJudgmentVO.java:10-34](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedJudgmentVO.java#L10-L34)
- [ExtractedPartyVO.java:10-36](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedPartyVO.java#L10-L36)
- [ExtractedLawyerVO.java:10-31](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedLawyerVO.java#L10-L31)
- [ExtractedJudgeVO.java:10-29](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedJudgeVO.java#L10-L29)
- [ExtractedEvidenceVO.java:10-33](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedEvidenceVO.java#L10-L33)
- [ExtractedProvisionVO.java:10-35](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/ExtractedProvisionVO.java#L10-L35)
...
## 结论
Graphiti-Java为法律数据抽取与导入提供了完整的端到端解决方案：从JSON预处理与字段映射，到LLM结构化抽取与本体约束验证，再到Neo4j存储与向量索引，最终形成可检索、可审计、可扩展的法律知识图谱。通过控制器-服务-嵌入-图数据库的清晰分层，系统既保证了工程化落地的可行性，也为后续的法律本体增强与相似性分析奠定了坚实基础。
...
**章节来源**
- [LegalImportController.java:42-135](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/LegalImportController.java#L42-L135)
...
- [LegalExtractServiceImpl.java:126-164](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/LegalExtractServiceImpl.java#L126-L164)
...
- [LegalExtractController.java:160-268](file://graphiti-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/LegalExtractController.java#L160-L268)