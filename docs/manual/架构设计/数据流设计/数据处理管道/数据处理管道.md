...
## 简介
本文件系统化梳理 ontograph-java 的数据处理管道，覆盖三大核心流程：
...
## 项目结构
ontograph-java 采用模块化分层设计，核心数据处理逻辑集中在 ontograph-module-core 模块的服务层，控制器负责对外暴露 REST API，前端通过 ontograph-web 提供可视化导入与监控界面。

```mermaid
graph TB
subgraph "前端"
WEB["ontograph-web<br/>Vue3 + TypeScript"]
...
- [EntityExtractorServiceImpl.java:26-306](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/EntityExtractorServiceImpl.java#L26-L306)
- [EdgeExtractorServiceImpl.java:26-362](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/EdgeExtractorServiceImpl.java#L26-L362)
- [EntityDedupServiceImpl.java:41-398](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/EntityDedupServiceImpl.java#L41-L398)
...
- [EdgeServiceImpl.java:25-172](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/EdgeServiceImpl.java#L25-L172)
- [LegalExtractServiceImpl.java:22-820](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/LegalExtractServiceImpl.java#L22-L820)
...
- [EdgeServiceImpl.java:25-172](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/EdgeServiceImpl.java#L25-L172)
- [LegalExtractServiceImpl.java:22-820](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/LegalExtractServiceImpl.java#L22-L820)
- [ExtractedEntityVO.java:14-37](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/extractor/ExtractedEntityVO.java#L14-L37)
- [BatchExtractEntitiesVO.java:12-23](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/extractor/BatchExtractEntitiesVO.java#L12-L23)
- [LegalExtractResultVO.java:18-81](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/LegalExtractResultVO.java#L18-L81)
- [data.ts:132-201](file://ontograph-web/src/api/data.ts#L132-L201)
...
- [DataImportServiceImpl.java:36-109](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/DataImportServiceImpl.java#L36-L109)
...
- [data.ts:139-185](file://ontograph-web/src/api/data.ts#L139-L185)
...
**图表来源**
- [EntityExtractorServiceImpl.java:52-128](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/EntityExtractorServiceImpl.java#L52-L128)
- [ExtractedEntityVO.java:14-37](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/extractor/ExtractedEntityVO.java#L14-L37)
- [BatchExtractEntitiesVO.java:12-23](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/extractor/BatchExtractEntitiesVO.java#L12-L23)
...
**图表来源**
- [LegalExtractServiceImpl.java:76-206](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/LegalExtractServiceImpl.java#L76-L206)
- [LegalExtractResultVO.java:18-81](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/vo/legal/LegalExtractResultVO.java#L18-L81)
...
**章节来源**
- [DataImportController.java:32-111](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/controller/admin/DataImportController.java#L32-L111)
- [DataImportServiceImpl.java:267-279](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/DataImportServiceImpl.java#L267-L279)
...
## 结论
ontograph-java 的数据处理管道以 LLM 为核心，结合本体校验、嵌入向量与 Neo4j 存储，形成从非结构化到结构化知识图谱的完整流水线。通过三层实体去重策略与严格的本体检错，确保数据质量与一致性。建议在生产环境中进一步优化批量处理、嵌入缓存与存储写入，并完善性能监控与告警体系，以支撑大规模知识图谱构建与检索需求。
