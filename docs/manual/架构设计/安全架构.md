...
- [PasswordTest.java](file://ontograph-server/src/test/java/PasswordTest.java)
</cite>-->
...
章节来源
- [SecurityConfig.java:35-136](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/config/SecurityConfig.java#L35-L136)
...
章节来源
- [SecurityConfig.java:65-136](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/config/SecurityConfig.java#L65-L136)
- [JwtAuthenticationFilter.java:26-59](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/jwt/JwtAuthenticationFilter.java#L26-L59)
- [JwtTokenProvider.java:19-86](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/jwt/JwtTokenProvider.java#L19-L86)
...
- [AuthServiceImpl.java:26-65](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/AuthServiceImpl.java#L26-L65)
- [LoginRequest.java:10-25](file://ontograph-module-system/src/main/java/com/graphiti/system/dto/LoginRequest.java#L10-L25)
...
- [PasswordTest.java:6-15](file://ontograph-server/src/test/java/PasswordTest.java#L6-L15)
...
- [SecurityConfig.java:115-136](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/config/SecurityConfig.java#L115-L136)
- [JwtAuthenticationFilter.java:44-58](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/jwt/JwtAuthenticationFilter.java#L44-L58)
...
- XSS 防护
  - 后端未直接渲染用户输入；前端负责渲染与转义（本仓库前端位于 ontograph-web）
  - 建议在网关或反向代理层增加通用安全头（如 Content-Security-Policy）
- 统一错误响应
  - BusinessException 与 GlobalExceptionHandler 提供统一错误码与消息

章节来源
- [LoginRequest.java:17-24](file://ontograph-module-system/src/main/java/com/graphiti/system/dto/LoginRequest.java#L17-L24)
...
- [SecurityConfig.java:118](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/config/SecurityConfig.java#L118)
...
章节来源
- [UserDetailsServiceImpl.java:37-40](file://ontograph-module-system/src/main/java/com/graphiti/system/service/UserDetailsServiceImpl.java#L37-L40)
- [SecurityConfig.java:121-126](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/config/SecurityConfig.java#L121-L126)
...
- [AuthController.java:21](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/AuthController.java#L21)
