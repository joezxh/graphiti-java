...
## 简介
本技术选型文档面向技术负责人与架构师，系统梳理 Graphiti-Java 后端与前端在 Spring Boot 3.5.5、Spring AI 1.1.2、Vue 3.4、Neo4j、MySQL/PostgreSQL、Redis、Spring Security 等关键组件上的技术决策与权衡，并给出替代方案对比、版本兼容性矩阵与升级路径建议，帮助团队在功能演进与长期维护之间取得平衡。
...
graph TB
subgraph "后端"
A["graphiti-framework<br/>通用能力封装"]
B["graphiti-module-system<br/>系统管理模块"]
C["graphiti-module-core<br/>核心业务模块"]
D["graphiti-server<br/>应用入口与配置"]
end
subgraph "前端"
E["graphiti-web<br/>Vue 3 前端工程"]
end
subgraph "基础设施"
F["Neo4j 图数据库"]
...
- [graphiti-spring-boot-starter-mybatis\pom.xml:19-49](file://graphiti-framework/graphiti-spring-boot-starter-mybatis/pom.xml#L19-L49)
...
**图表来源**
- [SecurityConfig.java:115-136](file://graphiti-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/config/SecurityConfig.java#L115-L136)
- [OpenAiLlmClientServiceImpl.java:36-53](file://graphiti-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/ai/OpenAiLlmClientServiceImpl.java#L36-L53)
- [GraphNeo4jConfig.java:41-45](file://graphiti-module-core/src/main/java/com/raphiti/module/graphiti/config/GraphNeo4jConfig.java#L41-L45)
- [application.yml:20-34](file://graphiti-server/src/main/resources/application.yml#L20-L34)
...
**图表来源**
- [GraphitiAiProperties.java:15-135](file://graphiti-module-core/src/main/java/com/raphiti/module/graphiti/config/GraphitiAiProperties.java#L15-L135)
- [OpenAiLlmClientServiceImpl.java:36-111](file://graphiti-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/ai/OpenAiLlmClientServiceImpl.java#L36-L111)
- [QwenLlmClientServiceImpl.java:23-98](file://graphiti-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/ai/QwenLlmClientServiceImpl.java#L23-L98)
...
**图表来源**
- [GraphNeo4jConfig.java:21-45](file://graphiti-module-core/src/main/java/com/raphiti/module/graphiti/config/GraphNeo4jConfig.java#L21-L45)
...
**图表来源**
- [application.yml:142-147](file://graphiti-server/src/main/resources/application.yml#L142-L147)
...
**章节来源**
- [package.json:11-31](file://graphiti-web/package.json#L11-L31)
