...
- ontograph-framework：公共组件与基础能力（安全、MyBatis、Redis 等）
- ontograph-module-system：系统管理（用户、角色、菜单、认证）
- ontograph-module-core：知识图谱核心（图管理、节点/边、本体、检索、导入、社区等）
...
**章节来源**
- [GraphitiServiceImpl.java:30-184](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/GraphitiServiceImpl.java#L30-L184)
...
- [OntologyValidationServiceImpl.java:40-87](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/service/impl/OntologyValidationServiceImpl.java#L40-L87)
- [SecurityConfig.java:116-136](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/graphiti/framework/security/config/SecurityConfig.java#L116-L136)
- [GraphitiAiProperties.java:16-56](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/config/GraphitiAiProperties.java#L16-L56)
...
```mermaid
graph TB
FE["ontograph-frontend<br/>Vue 3 前端"]
BE["ontograph-server<br/>Spring Boot 入口"]
...
**图表来源**
- [SecurityConfig.java:44-136](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/figiti/framework/security/config/SecurityConfig.java#L44-L136)
- [GraphitiAiProperties.java:16-135](file://ontograph-module-core/src/main/java/com/figiti/module/graphiti/config/GraphitiAiProperties.java#L16-L135)

**章节来源**
- [SecurityConfig.java:116-136](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/figiti/framework/security/config/SecurityConfig.java#L116-L136)
- [GraphitiAiProperties.java:16-56](file://ontograph-module-core/src/main/java/com/figiti/module/graphiti/config/GraphitiAiProperties.java#L16-L56)
...
```mermaid
graph LR
ROOT["ontograph-java<br/>聚合 POM"] --> FW["ontograph-framework"]
...
- [GraphitiApplication.java:20-33](file://ontograph-server/src/main/java/com/figiti/GraphitiApplication.java#L20-L33)
...
- [SearchServiceImpl.java:152-174](file://ontograph-module-core/src/main/java/com/figiti/module/graphiti/service/impl/SearchServiceImpl.java#L152-L174)
...
**章节来源**
- [SecurityConfig.java:84-113](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/figiti/framework/security/config/SecurityConfig.java#L84-L113)
- [OntologyValidationServiceImpl.java:40-87](file://ontograph-module-core/src/main/java/com/figiti/module/graphiti/service/impl/OntologyValidationServiceImpl.java#L40-L87)
