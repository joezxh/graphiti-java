...
## 项目结构
- 后端入口模块：ontograph-server（Spring Boot 启动类与配置）
- 核心业务模块：ontograph-module-core（知识图谱、搜索、导入、本体、社区等）
- 系统管理模块：ontograph-module-system（用户/角色/菜单/认证）
- 框架基础设施：ontograph-framework（通用组件、安全、MyBatis、Redis）
- 前端工程：ontograph-web（Vue 3 + Vite）
...
C["ontograph-module-core<br/>知识图谱/搜索/导入/本体"]
SYS["ontograph-module-system<br/>用户/角色/菜单/认证"]
...
- [ontograph-server/src/main/resources/application-dev.yml:508-517](file://ontograph-server/src/main/resources/application-dev.yml#L508-L517)
- [ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/config/GraphitiAiProperties.java:15-31](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/config/GraphitiAiProperties.java#L15-L31)
- [ontograph-module-core/src/main/java/com/Graphiti/module/graphiti/config/GraphNeo4jConfig.java:20-45](file://ontograph-module-core/src/main/java/com/graphiti/module/graphiti/config/GraphNeo4jConfig.java#L20-L45)
...
```mermaid
graph TB
Client["浏览器/CLI"] --> FE["ontograph-web(Vite)<br/>前端开发服务器"]
FE --> BE["ontograph-server(Spring Boot)<br/>REST API"]
...
### 启动流程
- 后端启动
  - 进入 ontograph-server 目录，执行启动命令，等待服务就绪。
- 前端启动
  - 进入 ontograph-web 目录，安装依赖后启动开发服务器。
- 访问 Swagger
...
章节来源
- [sql/neo4j/vector-index-init.cypher:1-27](file://sql/neo4j/vector-index-init.cypher#L1-L27)
- [ontograph-server/src/main/resources/application-dev.yml:498-502](file://ontograph-server/src/main/resources/application-dev.yml#L498-L502)
...
章节来源
- [ontograph-server/src/main/resources/application.yml:36-41](file://ontograph-server/src/main/resources/application.yml#L36-L41)
- [ontograph-web/vite.config.ts:18-26](file://ontograph-web/vite.config.ts#L18-L26)
- [sql/neo4j/init.cypher:1-33](file://sql/neo4j/init.cypher#L1-L33)
- [sql/neo4j/vector-index-init.cypher:1-27](file://sql/neo4j/vector-index-init.cypher#L1-L27)
