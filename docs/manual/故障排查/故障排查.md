...
- [Neo4jDriverAdapter.java](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/Neo4jDriverAdapter.java)
- [GraphNeo4jService.java](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/GraphNeo4jService.java)
...
- [AnthropicLlmClientServiceImpl.java](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/ai/AnthropicLlmClientServiceImpl.java)
...
- [OntologyValidationException.java](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/exception/OntologyValidationException.java)
...
## 项目结构
- 服务入口与配置：ontograph-server 提供 Spring Boot 入口与多环境配置（dev/prod）
- 通用层：graphiti-common 定义统一响应、错误码与全局异常处理
- 核心模块：ontograph-module-core 实现图谱、本体、实体抽取、向量化检索等能力，并集成 Neo4j 与 AI 服务
...
- [GraphNeo4jService.java:853-972](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/GraphNeo4jService.java#L853-L972)
- [GraphNeo4jConfig.java:1-47](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/config/GraphNeo4jConfig.java#L1-L47)
- [Neo4jDriverAdapter.java:1-84](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/Neo4jDriverAdapter.java#L1-L84)
- [GraphitiAiProperties.java:1-135](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/config/GraphitiAiProperties.java#L1-L135)
- [OpenAiLlmClientServiceImpl.java:39-110](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/ai/OpenAiLlmClientServiceImpl.java#L39-L110)
- [QwenLlmClientServiceImpl.java:28-73](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/ai/QwenLlmClientServiceImpl.java#L28-L73)
- [AnthropicLlmClientServiceImpl.java:36-76](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/ai/AnthropicLlmClientServiceImpl.java#L36-L76)
- [JwtAuthenticationFilter.java:1-61](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/raphiti/framework/security/jwt/JwtAuthenticationFilter.java#L1-L61)
- [JwtTokenProvider.java:1-87](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/raphiti/framework/security/jwt/JwtTokenProvider.java#L1-L87)
...
图表来源
- [GraphitiServiceImpl.java:118-158](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/GraphitiServiceImpl.java#L118-L158)
...
- [JwtAuthenticationFilter.java:1-61](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/raphiti/framework/security/jwt/JwtAuthenticationFilter.java#L1-L61)
- [JwtTokenProvider.java:1-87](file://ontograph-framework/graphiti-spring-boot-starter-security/src/main/java/com/raphiti/framework/security/jwt/JwtTokenProvider.java#L1-L87)
- [application.yml:58-67](file://ontograph-server/src/main/resources/application.yml#L58-L67)
...
章节来源
- [OntologyValidationException.java:1-31](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/exception/OntologyValidationException.java#L1-L31)
...
章节来源
- [TemporalServiceImpl.java:71-104](file://ontograph-module-core/src/main/java/com/raphiti/module/graphiti/service/impl/TemporalServiceImpl.java#L71-L104)