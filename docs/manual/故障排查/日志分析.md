...
- [log.ts](file://ontograph-web/src/api/log.ts)
- [index.vue（系统日志）](file://ontograph-web/src/views/system/log/index.vue)
- [monitor.ts](file://ontograph-web/src/api/monitor.ts)
- [index.vue（监控面板）](file://ontograph-web/src/views/monitor/index.vue)
...
## 简介
本文件面向OntoGraph项目的日志分析与监控，系统性说明日志配置、输出格式、存储位置、关键字段与分析技巧，并提供检索与过滤最佳实践、性能瓶颈定位、错误模式识别、系统异常排查以及日志轮转与聚合方案。
...
- 前端层
  - 日志管理页面：ontograph-web/src/views/system/log/index.vue
  - 日志API封装：ontograph-web/src/api/log.ts
  - 监控面板：ontograph-web/src/views/monitor/index.vue
  - 监控API封装：ontograph-web/src/api/monitor.ts
- 异常与全局处理
...
**图表来源**
- [application-dev.yml:608-676](file://ontograph-server/src/main/resources/application-dev.yml#L608-L676)
...
- [OperationLogService.java:1-44](file://ontograph-module-system/src/main/java/com/graphiti/system/service/OperationLogService.java#L1-L44)
- [OperationLogServiceImpl.java:34-71](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/OperationLogServiceImpl.java#L34-L71)
...
- [OperationLogMapper.java:1-12](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/mysql/OperationLogMapper.java#L1-L12)
- [log.ts:1-133](file://ontograph-web/src/api/log.ts#L1-L133)
- [index.vue（系统日志）:1-406](file://ontograph-web/src/views/system/log/index.vue#L1-L406)
- [monitor.ts:89-122](file://ontograph-web/src/api/monitor.ts#L89-L122)
- [index.vue（监控面板）:171-494](file://ontograph-web/src/views/monitor/index.vue#L171-L494)

**章节来源**
- [application.yml:35-67](file://ontograph-server/src/main/resources/application.yml#L35-L67)
- [application-dev.yml:608-676](file://ontograph-server/src/main/resources/application-dev.yml#L608-L676)
- [application-prod.yml:196-205](file://config/application-prod.yml#L196-L205)
- [logback-prod.xml:1-84](file://config/logback-prod.xml#L1-L84)
...
- [OperationLogController.java:27-56](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/OperationLogController.java#L27-L56)
- [OperationLogService.java:14-44](file://ontograph-module-system/src/main/java/com/graphiti/system/service/OperationLogService.java#L14-L44)
- [OperationLogServiceImpl.java:34-71](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/OperationLogServiceImpl.java#L34-L71)
- [log.ts:36-131](file://ontograph-web/src/api/log.ts#L36-L131)
- [index.vue（系统日志）:249-355](file://ontograph-web/src/views/system/log/index.vue#L249-L355)
...
**图表来源**
- [OperationLogController.java:27-56](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/OperationLogController.java#L27-L56)
- [OperationLogService.java:14-17](file://ontograph-module-system/src/main/java/com/graphiti/system/service/OperationLogService.java#L14-L17)
- [OperationLogServiceImpl.java:34-56](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/OperationLogServiceImpl.java#L34-L56)
- [OperationLogMapper.java:1-12](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/mysql/OperationLogMapper.java#L1-L12)
- [log.ts:36-73](file://ontograph-web/src/api/log.ts#L36-L73)
- [index.vue（系统日志）:249-263](file://ontograph-web/src/views/system/log/index.vue#L249-L263)
...
**图表来源**
- [OperationLogDO.java:17-41](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/dataobject/OperationLogDO.java#L17-L41)
...
- [monitor.ts:89-122](file://ontograph-web/src/api/monitor.ts#L89-L122)
- [index.vue（监控面板）:256-288](file://ontograph-web/src/views/monitor/index.vue#L256-L288)
...
- [OperationLogController.java:25-26](file://ontograph-module-system/src/main/java/com/graphiti/system/controller/OperationLogController.java#L25-L26)
- [OperationLogService.java:10-11](file://ontograph-module-system/src/main/java/com/graphiti/system/service/OperationLogService.java#L10-L11)
- [OperationLogServiceImpl.java:34-56](file://ontograph-module-system/src/main/java/com/graphiti/system/service/impl/OperationLogServiceImpl.java#L34-L56)
- [OperationLogMapper.java:1-12](file://ontograph-module-system/src/main/java/com/graphiti/system/dal/mysql/OperationLogMapper.java#L1-L12)
- [log.ts:36-73](file://ontograph-web/src/api/log.ts#L36-L73)
- [monitor.ts:89-122](file://ontograph-web/src/api/monitor.ts#L89-L122)
...
**章节来源**
- [GlobalExceptionHandler.java:26-72](file://ontograph-framework/graphiti-common/src/main/java/com/graphiti/common/exception/GlobalExceptionHandler.java#L26-L72)
- [index.vue（系统日志）:266-290](file://ontograph-web/src/views/system/log/index.vue#L266-L290)
- [logback-prod.xml:16-24](file://config/logback-prod.xml#L16-L24)

## 结论
OntoGraph的日志体系在开发与生产环境分别采用差异化配置，既保证开发调试效率，又满足生产性能与合规要求。结合操作日志与监控面板，可实现对请求行为、性能与异常的全链路观测与快速定位。
...
- 轮转策略
  ...
  - 保留30天，总量上限3GB
- 存储位置
  - 文件输出路径：/app/logs/ontograph-java.log
- 建议
