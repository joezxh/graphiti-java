...
- [assets/styles/dark.less](file://ontograph-web/src/assets/styles/dark.less)
...
## 简介
本文件面向前端开发者与UI/UX设计师，系统梳理OntoGraph前端应用（基于Vue.js 3）的架构与实现要点。内容涵盖项目结构、路由与状态管理、组件分层设计、与后端API的集成方式（含Axios封装、认证与错误处理）、构建与部署流程、样式与主题定制、开发与调试技巧以及性能优化建议。目标是帮助团队快速理解并高效迭代该单页应用。
...
- [assets/styles/dark.less:1-49](file://ontograph-web/src/assets/styles/dark.less#L1-L49)
...
- [store/modules/user.ts:35-44](file://ontograph-web/src/store/modules/user.ts#L35-L44)
- [api/auth.ts:43-49](file://ontograph-web/src/api/auth.ts#L43-L49)
- [api/request.ts:35-61](file://ontograph-web/src/api/request.ts#L35-L61)
...
图表来源
- [api/request.ts:5-138](file://ontograph-web/src/api/request.ts#L5-L138)
...
章节来源
- [router/index.ts:185-230](file://ontograph-web/src/router/index.ts#L185-L230)
- [views/dashboard/index.vue:229-249](file://ontograph-web/src/views/dashboard/index.vue#L229-L249)
...
- [vite.config.ts:27-39](file://ontograph-web/vite.config.ts#L27-L39)
- [tsconfig.json:18-22](file://ontograph-web/tsconfig.json#L18-L22)
...
- [vite.config.ts:14-26](file://ontograph-web/vite.config.ts#L14-L26)
...
章节来源
- [api/request.ts:6](file://ontograph-web/src/api/request.ts#L6)
- [vite.config.ts:20-25](file://ontograph-web/vite.config.ts#L20-L25)
...
章节来源
- [views/dashboard/index.vue:13-16](file://ontograph-web/src/views/dashboard/index.vue#L13-L16)
- [api/request.ts:46-48](file://ontograph-web/src/api/request.ts#L46-L48)