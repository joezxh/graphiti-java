...
- [setup.bat](file://ontograph-web/setup.bat)
- [install.bat](file://ontograph-web/install.bat)
...
## 项目结构
前端工程位于 ontograph-web 目录，采用 Vue 3 单页应用架构，配合 Vite 作为构建工具与开发服务器，使用 TypeScript 进行类型管理，Ant Design Vue 提供 UI 组件库，Pinia 管理状态，Axios 发起 HTTP 请求，Less 处理样式与主题变量。

```mermaid
graph TB
subgraph "前端应用 ontograph-web"
...
- [setup.bat:1-32](file://ontograph-web/setup.bat#L1-L32)
- [install.bat:1-10](file://ontograph-web/install.bat#L1-L10)
...
章节来源
- [tsconfig.json:1-25](file://ontograph-web/tsconfig.json#L1-L25)
- [package.json:9-9](file://ontograph-web/package.json#L9-L9)
...
章节来源
- [router/index.ts:181-230](file://ontograph-web/src/router/index.ts#L181-L230)
- [store/modules/user.ts:21-44](file://ontograph-web/src/store/modules/user.ts#L21-L44)
...
章节来源
- [vite.config.ts:14-17](file://ontograph-web/vite.config.ts#L14-L17)
...
章节来源
- [setup.bat:11-18](file://ontograph-web/setup.bat#L11-L18)
- [vite.config.ts:18-26](file://ontograph-web/vite.config.ts#L18-L26)
...
图表来源
- [package.json:6-6](file://ontograph-web/package.json#L6-L6)
- [vite.config.ts:18-26](file://ontograph-web/vite.config.ts#L18-L26)
