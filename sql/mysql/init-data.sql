...
(@v_def_id, 'http://legal-ai.cc/ontology/CivilCase', 'CivilCase', NULL, '民事案件，包括婚姻家庭纠纷、继承纠纷、合同纠纷等传统民事领域案件。', '{"caseNumber": "（2020）渝民辖188号", "caseName": "谭某诉吴某债权人撤销权纠纷案"}', 'KNOWLEDGE', '{"icon": "civil", "color": "#FFF3E0", "displayPriority": 3}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(@v_def_id, 'http://legal-ai.cc/ontology/CriminalCase', 'CriminalCase', NULL, '刑事案件，包括公诉案件和自诉案件。', '{"caseNumber": "（2022）沪01刑初123号", "caseName": "徐某故意杀人案"}', 'KNOWLEDGE', '{"icon": "criminal", "color": "#FFEBEE", "displayPriority": 4}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(@v_def_id, 'http://legal-ai.cc/ontology/property/caseName', 'caseName', 'DATATYPE', @case_class_id, 'string', 1, 1, 1, 0, '案件名称', '徐某骥诉上海某物业管理有限公司等公司解散纠纷案', '{"displayName": "案件名称", "formType": "text"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(@v_def_id, 'http://legal-ai.cc/ontology/property/caseType', 'caseType', 'DATATYPE', @case_class_id, 'string', 1, 1, 1, 0, '案件类型：民事、刑事、行政、商事、执行、赔偿', '民事', '{"displayName": "案件类型", "formType": "select", "allowedValues": ["民事", "刑事", "行政", "商事", "执行", "赔偿"]}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(@v_def_id, 'http://legal-ai.cc/ontology/property/caseStatus', 'caseStatus', 'DATATYPE', @case_class_id, 'string', 0, 1, 0, 0, '案件状态', '结案', '{"displayName": "案件状态", "formType": "select", "allowedValues": ["立案", "审理中", "调解中", "判决", "上诉中", "结案", "撤销"]}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(@v_def_id, 'http://legal-ai.cc/ontology/property/filingDate', 'filingDate', 'DATATYPE', @case_class_id, 'date', 0, 1, 0, 0, '立案日期', '2023-01-15', '{"displayName": "立案日期", "formType": "date"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(@v_def_id, 'http://legal-ai.cc/ontology/property/closedDate', 'closedDate', 'DATATYPE', @case_class_id, 'date', 0, 1, 0, 0, '结案日期', '2023-05-04', '{"displayName": "结案日期", "formType": "date"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(@v_def_id, 'http://legal-ai.cc/ontology/property/partyType', 'partyType', 'DATATYPE', @party_class_id, 'string', 1, 1, 1, 0, '当事人类型：自然人、法人、非法人组织', '自然人', '{"displayName": "当事人类型", "formType": "select", "allowedValues": ["自然人", "法人", "非法人组织"]}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(@v_def_id, 'http://legal-ai.cc/ontology/property/partyRole', 'partyRole', 'DATATYPE', @party_class_id, 'string', 1, 1, 1, 0, '诉讼角色', '原告', '{"displayName": "诉讼角色", "formType": "select", "allowedValues": ["原告", "被告", "第三人", "上诉人", "被上诉人", "申请人", "被申请人"]}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(@v_def_id, 'http://legal-ai.cc/ontology/property/articleNumber', 'articleNumber', 'DATATYPE', @legalprovision_class_id, 'string', 1, 1, 1, 0, '条款序号', '第69条', '{"displayName": "条款序号", "formType": "text"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(@v_def_id, 'http://legal-ai.cc/ontology/property/provisionContent', 'provisionContent', 'DATATYPE', @legalprovision_class_id, 'text', 1, 1, 1, 0, '条文完整内容', '法人清算后的剩余财产，按照法人章程的规定或者法人权力机构的决议处理。', '{"displayName": "条文内容", "formType": "textarea"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(@v_def_id, 'http://legal-ai.cc/ontology/property/lawName', 'lawName', 'DATATYPE', @legalprovision_class_id, 'string', 1, 1, 1, 0, '所属法律文件名称', '中华人民共和国民法典', '{"displayName": "法律名称", "formType": "text"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(@v_def_id, 'http://legal-ai.cc/ontology/property/documentType', 'documentType', 'DATATYPE', @judgmentdocument_class_id, 'string', 0, 1, 0, 0, '文书类型', '民事判决书', '{"displayName": "文书类型", "formType": "select", "allowedValues": ["判决书", "裁定书", "调解书", "决定书", "裁决书"]}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(@v_def_id, 'http://legal-ai.cc/ontology/property/issueDate', 'issueDate', 'DATATYPE', @judgmentdocument_class_id, 'date', 0, 1, 0, 0, '文书作出日期', '2023-05-04', '{"displayName": "作出日期", "formType": "date"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(@v_def_id, 'http://legal-ai.cc/ontology/property/performanceMethod', 'performanceMethod', 'DATATYPE', @mediationagreement_class_id, 'string', 0, 1, 0, 0, '履行方式', '银行转账', '{"displayName": "履行方式", "formType": "text"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO ont_constraint (definition_id, class_id, property_id, constraint_type, value, error_message, severity, description, created_at, updated_at)
VALUES (@v_def_id, @party_class_id, @partyType_prop_id, 'ENUM', '["自然人", "法人", "非法人组织"]', '当事人类型必须是：自然人、法人 或 非法人组织', 'ERROR', '确保当事人类型字段的数据质量', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

SET @partyRole_prop_id = (SELECT id FROM ont_property WHERE definition_id = @v_def_id AND local_name = 'partyRole');
INSERT INTO ont_constraint (definition_id, class_id, property_id, constraint_type, value, error_message, severity, description, created_at, updated_at)
VALUES (@v_def_id, @party_class_id, @partyRole_prop_id, 'ENUM', '["原告", "被告", "第三人", "上诉人", "被上诉人", "申请人", "被申请人"]', '诉讼角色必须在允许范围内', 'ERROR', '确保诉讼角色字段的数据质量', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

SET @legalprovision_class_id = (SELECT id FROM ont_class WHERE definition_id = @v_def_id AND local_name = 'LegalProvision');
SET @lawType_prop_id = (SELECT id FROM ont_property WHERE definition_id = @v_def_id AND local_name = 'lawType');
INSERT INTO ont_constraint (definition_id, class_id, property_id, constraint_type, value, error_message, severity, description, created_at, updated_at)
VALUES (@v_def_id, @legalprovision_class_id, @lawType_prop_id, 'ENUM', '["法律", "行政法规", "司法解释", "部门规章", "地方性法规"]', '法律类型必须在允许范围内', 'ERROR', '确保法律类型字段的数据质量', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

SET @judgmentdocument_class_id = (SELECT id FROM ont_class WHERE definition_id = @v_def_id AND local_name = 'JudgmentDocument');
SET @documentType_prop_id = (SELECT id FROM ont_property WHERE definition_id = @v_def_id AND local_name = 'documentType');
INSERT INTO ont_constraint (definition_id, class_id, property_id, constraint_type, value, error_message, severity, description, created_at, updated_at)
VALUES (@v_def_id, @judgmentdocument_class_id, @documentType_prop_id, 'ENUM', '["判决书", "裁定书", "调解书", "决定书", "裁决书"]', '文书类型必须在允许范围内', 'ERROR', '确保裁判文书类型字段的数据质量', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

SET @mediationagreement_class_id = (SELECT id FROM ont_class WHERE definition_id = @v_def_id AND local_name = 'MediationAgreement');
SET @agreementNumber_prop_id = (SELECT id FROM ont_property WHERE definition_id = @v_def_id AND local_name = 'agreementNumber');
INSERT INTO ont_constraint (definition_id, class_id, property_id, constraint_type, value, error_message, severity, description, created_at, updated_at)
...
('LEGAL_ENTITY_EXTRACT', '法律实体抽取', '从裁判文书中抽取法律领域实体', 'entity_extract',
 ...
 1, NULL, 1, '["legal", "entity"]', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('LEGAL_EDGE_EXTRACT', '法律关系抽取', '从裁判文书中抽取实体之间的关系', 'edge_extract',
 ...
 1, NULL, 2, '["legal", "edge"]', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
