-- ============================================================
-- 法律知识图谱本体定义数据 (PostgreSQL)
-- ============================================================

-- 图谱元数据
INSERT INTO graphiti_graph_metadata (graph_id, name, description, node_count, edge_count)
VALUES ('legal-knowledge-graph', '法律知识图谱', '基于典型案例、商事调解条例的法律领域知识图谱', 0, 0)
  ...
  '[
    ...
    },
    {
      ...
      "properties": {
        ...
        "title": {"type": "string", "description": "职务", "enum": ["审判长", "审判员", "人民陪审员", "书记员"]},
    ...
    },
    {
      ...
      "properties": {
        ...
        "qualification": {"type": "string", "description": "资质类型"},
