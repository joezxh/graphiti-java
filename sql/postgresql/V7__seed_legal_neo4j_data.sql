-- ============================================================
-- 法律知识图谱 Neo4j 示例数据 (PostgreSQL 元数据 + Neo4j 节点/关系)
-- 版本: V7
-- 描述: 基于真实法院典型案例数据构建的 Neo4j 图谱节点和关系
-- 数据来源: 人民法院案例库真实案例 (2025年入库)
-- 创建时间: 2026-05-12
-- Neo4j 版本: 5.x (APOC plugin recommended)
-- ============================================================

-- ----------------------------------------------------------
-- Neo4j 连接参数 (请根据实际环境修改)
-- ----------------------------------------------------------
-- :BEGIN
-- param graphId = 'legal-knowledge-graph'
-- param defId = (SELECT id FROM ont_definition WHERE graph_id = 'legal-knowledge-graph' AND version = '2.0.0' LIMIT 1)

-- ----------------------------------------------------------
-- 第一部分: Neo4j 约束与索引 (Cypher)
-- ----------------------------------------------------------
...
// [4] 文本索引 (中文分词)
// Neo4j 5.x TEXT INDEX 支持中文搜索，analyzer 在部分版本可能不支持 indexConfig 参数
// 如需更精细的中文分词（JieBa 等），需要安装 APOC 插件并配置 tokenizer
...
// 最高人民法院
CREATE CONSTRAINT court_supreme_unique IF NOT EXISTS
FOR (n:Court) REQUIRE n.courtName IS UNIQUE;
...
-- 法条-法条关系: 商事调解条例内部关联
MATCH (a:LegalProvision {provisionId: 'SMTL-001'})
MATCH (b:LegalProvision {provisionId: 'SMTL-002'})
...
MATCH (a:LegalProvision {provisionId: 'SMTL-012'})
MATCH (b:LegalProvision {provisionId: 'SMTL-008'})
MERGE (a)-[r:LEGAL_PROVISION_RELATED {
...
MATCH (a:LegalProvision {provisionId: 'SMTL-022'})
MATCH (b:LegalProvision {provisionId: 'SMTL-014'})
MERGE (a)-[r:LEGAL_PROVISION_RELATED {
...
// 公司解散相关法条关联
MATCH (a:LegalProvision {provisionId: 'MFD-069'})
MATCH (b:LegalProvision {provisionId: 'GSF2-001'})
MERGE (a)-[r:LEGAL_PROVISION_RELATED {
...
// 民事诉讼法条文关联
MATCH (a:LegalProvision {provisionId: 'MSSSF-023'})
MATCH (b:LegalProvision {provisionId: 'MSSSF-022'})
MERGE (a)-[r:LEGAL_PROVISION_RELATED {
...
// 关联事实和要旨
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (f:CaseFact {factDescription: '2020年3月30日，原告受让被告五位股东持有的股权，成为上海某物业管理有限公司股东，持股39.54%'})
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (f:CaseFact {factDescription: '被告公司正常经营，自2020年4月至2022年1月多次召开股东会协商分红、办公场地等事宜，原告累计获得利润分配约1223070元'})
MERGE (ca)-[r:HAS_CASE_FACT {
  uuid: 'rel-c1-f2',
  factRole: '关键事实',
...
MATCH (ca:Case {caseNumber: '（2020）渝民辖188号'})
MATCH (r:CaseReasoning)
...
// ----------------------------------------------------------
-- 第九部分: 商事调解相关节点 (CommercialMediation)
// ----------------------------------------------------------
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (p:Party {partyName: '上海某物业管理有限公司'})
MERGE (ca)-[r:CASE_PARTY {
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (c:Court {courtName: '上海市第一中级人民法院'})
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (c:Court {courtName: '上海市长宁区人民法院'})
MERGE (ca)-[r:CASE_COURT {
...
MATCH (ca:Case {caseNumber: '（2020）渝民辖188号'})
MATCH (c:Court {courtName: '重庆市高级人民法院'})
MERGE (ca)-[r:CASE_COURT {
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (j:Judge {courtName: '上海市第一中级人民法院'})
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (j:Judge {courtName: '上海市长宁区人民法院'})
MERGE (ca)-[r:CASE_JUDGE {
...
MATCH (ca:Case {caseNumber: '（2020）渝民辖188号'})
MATCH (j:Judge {courtName: '重庆市高级人民法院'})
MERGE (ca)-[r:CASE_JUDGE {
  uuid: 'rel-c2-judge',
  role: '审判长',
  caseLevel: '管辖权审查'
...
// 案例一引用法条
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (lp:LegalProvision {articleNumber: '第69条', lawName: '中华人民共和国民法典'})
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (lp:LegalProvision {articleNumber: '第1条', provisionId: 'GSF2-001'})
MERGE (ca)-[r:CASE_LEGAL_PROVISION {
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (lp:LegalProvision {articleNumber: '第22条'})
MERGE (ca)-[r:CASE_LEGAL_PROVISION {
...
MATCH (ca:Case {caseNumber: '（2020）渝民辖188号'})
MATCH (lp:LegalProvision {articleNumber: '第23条'})
MERGE (ca)-[r:CASE_LEGAL_PROVISION {
  uuid: 'rel-c2-prov-23',
  usageType: '适用',
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (jd:JudgmentDocument {documentNumber: '（2022）沪0105民初21387号'})
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (jd:JudgmentDocument {documentNumber: '（2023）沪01民终11293号'})
MERGE (ca)-[r:CASE_JUDGMENT {
...
MATCH (ca:Case {caseNumber: '（2020）渝民辖188号'})
MATCH (jd:JudgmentDocument {documentNumber: '（2020）渝民辖188号'})
MERGE (ca)-[r:CASE_JUDGMENT {
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (e:Evidence {evidenceNumber: '证据001'})
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (e:Evidence {evidenceNumber: '证据002'})
MERGE (ca)-[r:CASE_EVIDENCE {
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (e:Evidence {evidenceNumber: '证据003'})
MERGE (ca)-[r:CASE_EVIDENCE {
...
MATCH (ca:Case {caseNumber: '（2023）沪01民终11293号'})
MATCH (e:Evidence {evidenceNumber: '证据004'})
MERGE (ca)-[r:CASE_EVIDENCE {
...
MATCH (ca:Case {caseNumber: '（2024）沪0115商初1234号'})
MATCH (mo:CommercialMediationOrganization {name: '上海国际商事调解中心'})
...
MATCH (ca:Case {caseNumber: '（2024）沪0115商初1234号'})
MATCH (ma:MediationAgreement {agreementNumber: 'MA20240001'})
...
MATCH (supreme:Court {courtLevel: '最高人民法院'})
MATCH (shanghaiHigh:Court {courtName: '上海市高级人民法院'})
...
MATCH (shanghaiHigh:Court {courtName: '上海市高级人民法院'})
MATCH (shanghai1:Court {courtName: '上海市第一中级人民法院'})
...
MATCH (shanghai1:Court {courtName: '上海市第一中级人民法院'})
MATCH (changning:Court {courtName: '上海市长宁区人民法院'})
...
MATCH (ma:MediationAgreement {agreementNumber: 'MA20240001'})
MATCH (c:Court {courtName: '上海市浦东新区人民法院'})
...
// ----------------------------------------------------------
-- 第十一部分: 更新 PostgreSQL 图谱统计
-- ----------------------------------------------------------

// :BEGIN (PostgreSQL)
// UPDATE graphiti_graph_metadata
// SET node_count = (
//   SELECT COUNT(*)
//   FROM (
//     MATCH (n:Case) RETURN n
//     UNION ALL MATCH (n:Party) RETURN n
//     UNION ALL MATCH (n:Court) RETURN n
//     UNION ALL MATCH (n:Judge) RETURN n
//     UNION ALL MATCH (n:LegalProvision) RETURN n
//     UNION ALL MATCH (n:JudgmentDocument) RETURN n
//     UNION ALL MATCH (n:Evidence) RETURN n
//     UNION ALL MATCH (n:CaseReasoning) RETURN n
//     UNION ALL MATCH (n:CaseFact) RETURN n
//     UNION ALL MATCH (n:CommercialMediationOrganization) RETURN n
//     UNION ALL MATCH (n:Mediator) RETURN n
//     UNION ALL MATCH (n:MediationAgreement) RETURN n
//   ) AS nodes
// ),
// edge_count = (
//   SELECT COUNT(*)
//   FROM (
//     MATCH ()-[r:CASE_PARTY]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_COURT]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_JUDGE]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_LEGAL_PROVISION]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_JUDGMENT]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_EVIDENCE]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_REASONING]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_FACT]->() RETURN r
//     UNION ALL MATCH ()-[r:LEGAL_PROVISION_RELATED]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_RELATED]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_MEDIATION_ORG]->() RETURN r
//     UNION ALL MATCH ()-[r:CASE_MEDIATION_AGREEMENT]->() RETURN r
//     UNION ALL MATCH ()-[r:ORG_MEDIATOR]->() RETURN r
//     UNION ALL MATCH ()-[r:COURT_HIERARCHY]->() RETURN r
//     UNION ALL MATCH ()-[r:AGREEMENT_JUDICIALLY_CONFIRMED]->() RETURN r
//   ) AS edges
// ),
...
// 验证查询 - 查看所有节点类型及数量
// MATCH (n) WITH labels(n)[0] AS label, count(*) AS cnt RETURN label, cnt ORDER BY cnt DESC;

// 验证查询 - 查看关键案件节点
// MATCH (ca:Case) RETURN ca.caseNumber, ca.caseName, ca.caseStatus, ca.courtLevel;
...
// 验证查询 - 查看案件-当事人-法院完整图谱
// MATCH (p:Party)-[rp:CASE_PARTY]->(ca:Case)-[rc:CASE_COURT]->(c:Court)
